  ...
  if (getStorageItem("isLogin") === 'true') return <Navigate to={"/"} />
    ...
    <div className="h-full relative bg-white dark:bg-gray-600 w-full">
      <div className="absolute left-[50%] top-[50%] -translate-x-1/2 -translate-y-1/2">
        ...
        <form onSubmit={() => { setStorageItem("isLogin", "true"); navigate("/") }}>
          <div className="mt-4"><input className={`bg-gray-200 w-[400px] placeholder-black h-[52px] p-3 pl-4 rounded-full`} name="userName" type="text" placeholder="Username" required /></div>
          <div className="mt-2"><input className={`bg-gray-200 w-[400px] placeholder-black h-[52px] p-3 pl-4 rounded-full`} name="password" type="password" placeholder="Password" required /></div>
          <div className="mt-4"><button className="bg-blue-500 hover:bg-blue-700 text-white font-bold w-full  py-2 px-4 rounded-full" type="submit">Login</button></div>
        </form>
        <div className="mt-3">
